function Sigma1 = absorption_coef_O3(v1, P, T, Q, concnt_O3) % P:[hPa], T:[K]
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Q_ref   = 3483.71;         % at 296K
Ma      = 48.0;           % molar mass[g/mol]
P_self = concnt_O3*Ma/29.0*P_atm;    % Table: partial pressure for a gass [atm]

file_name = ["O3_289340.par"];

number_of_lines_to_read_per_pass = 210150;  % 289340; 
