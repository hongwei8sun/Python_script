function Sigma1 = absorption_coef_H2O(v1, P, T, Q, concnt_H2O) % P:[hPa], T:[K]
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Q_ref   = 174.58;         % at 296K
Ma      = 18.0;           % molar mass[g/mol]
P_self = concnt_H2O*Ma/29.0*P_atm;    % Table: partial pressure for a gass [atm]

file_name = ["H2O_141360.par"];

number_of_lines_to_read_per_pass = 19620;  %  141360;  %   % % ; 
