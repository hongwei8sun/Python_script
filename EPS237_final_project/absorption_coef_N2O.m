function Sigma1 = absorption_coef_N2O(v1, P, T, Q, concnt_N2O) % P:[hPa], T:[K]
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Q_ref   = 4984.90;         % at 296K
Ma      = 44.0;           % molar mass[g/mol]
P_self = concnt_N2O*Ma/29.0*P_atm;    % Table: partial pressure for a gass [atm]

file_name = ["N2O_33074.par"];

number_of_lines_to_read_per_pass = 33074;  %; 313943;  %
