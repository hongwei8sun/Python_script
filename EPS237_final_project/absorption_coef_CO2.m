function Sigma1 = absorption_coef_CO2(v1, P, T, Q, concnt_CO2) % P:[hPa], T:[K]
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Q_ref   = 286.09;         % at 296K
Ma      = 44.0;           % molar mass[g/mol]
P_self = concnt_CO2*Ma/29.0*P_atm;    % Table: partial pressure for a gass [atm]
% 280ppm to 560ppm

file_name = ["CO2_173024.par"];

number_of_lines_to_read_per_pass = 68831;  % 173024; 
